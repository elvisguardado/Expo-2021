                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <div class="center-align">
                            <h5>Gestión de Inventario Nuevo</h5>
                        </div>
                        <br>
                    ...
                    <br>
                    <div class="center-align">
                        <h5>Visualizar Inventario Nuevo</h5>
                    </div>
                    ...
                    <div class="card-content grey lighten-4">
                        ...
                        <table id="tabla1" class="highlight responsive-table centered">
                            <thead>
                                <tr>
                                    <th>Tipo_Producto</th> <!-- Parte superior de la tabla indicando que tipo de datos se ingresaran -->
                                    <th>Tipo_Color</th>
                                    <th>Descripcion</th>
                                    <th>Cantidad</th>
                                    <th>Precio</th>
                ...
                <div id="modal1" class="modal">
                    <div class="modal-content">
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <input type="text" placeholder="Ingrese la descripcion" id="nombre">
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <label for="nombre">Cantidad Inventario</label>
                        </div>
                        <!-- Estructura del formulario, cada div clas imput es una entrada de registro -->
                        <div class="input-field col s12 m6">
                            <i class="material-icons prefix">euro_symbol</i>
                            <input type="text" placeholder="Ingrese el precio" id="nombre">
                            <label for="nombre">Precio del inventario</label>
                        </div>
                        <!-- Boton para finalizar la creacion del registro -->
                        <div class="center-align">
...
plantilla_index::footerTemplate('inventario_nuevo.js');
?>