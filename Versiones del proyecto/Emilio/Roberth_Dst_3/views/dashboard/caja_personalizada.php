                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <div class="right-align">
                            <a class="waves-effect waves-light btn" onclick = "activarCampo()"><i class="material-icons left"></i>Crear una caja personalizada</a>
                        </div>
                        </div>
                      ...
                      <div class="input-field col s12 m6">
                              ...
                              <input type="text"  placeholder="Ingrese la cantidad del productos" id="nombre">
                              <label id = "CantidadProducto" for="disabled">Escriba la cantidad del producto</label>
                      </div>
...
plantilla_index::footerTemplate('caja_personaliza.js');
?>