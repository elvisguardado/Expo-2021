    ...
    <div class="card horizontal" id="nuestra_historia">
        ...
        <div class="card-stacked col s12 m12 l6">
            <div class="card-content">
                ...
                <div class="center">
                    <a href="https://www.facebook.com/RoberthDstsv/" target="_blank"><img
                            src="../../resources/img/index_public/facebook.png" HSPACE="25" VSPACE="10">
                    </a>
                    <a href="#" target="_blank"><img src="../../resources/img/index_public/twitter.png" HSPACE="25"
                            VSPACE="10">
                    </a>
                    <a href="#" target="_blank"><img src="../../resources/img/index_public/Whatsapp.png" HSPACE="25"
                            VSPACE="10">
                    </a>
                </div>
...
Planilla_Public::footerTemplate('index.js');
?>