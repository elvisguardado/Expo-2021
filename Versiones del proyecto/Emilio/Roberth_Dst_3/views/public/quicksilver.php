    ...
    <div class="row">
        ...
        <div class="col s12 m6 l4">
            ...
            <div class="card">
                ...
                <div class="card-image">
                    <img
                        src="../../resources/img/Trabajo_Pagina_Principal/Camisas/Camisas Marcas/Quicksilver/Quicksilver Surfboard.jpg" height="662">
                </div>
                <!--Contenido de la Card-->
                <div class="card-content center">
                    <p>
                        <strong>Quicksilver Surfboard</strong>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col s12 m6 l4">
            ...
            <div class="card">
                <!--Imagen de la Card-->
                <div class="card-image">
                    <img src="../../resources/img/Trabajo_Pagina_Principal/Camisas/Camisas Marcas/Quicksilver/Quicksilver Surfista.jpg"
                        height="662">
                </div>
                <!--Contenido de la Card-->
                <div class="card-content center">
                    <p>
                        <strong>Quicksilver Surfista</strong>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col s12 m6 l4">
            ...
            <div class="card">
                ...
                <div class="card-image">
                    <img
                        src="../../resources/img/Trabajo_Pagina_Principal/Camisas/Camisas Marcas/Quicksilver/QuickSilver Tablas.jpg" height="662">
                </div>
                <!--Contenido de la Card-->
                <div class="card-content center">
                    <p>
                        <strong>QuickSilver Tablas</strong>
                    </p>
                </div>
            </div>
        </div>
