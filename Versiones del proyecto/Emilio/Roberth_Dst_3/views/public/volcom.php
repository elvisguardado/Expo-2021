    ...
    <div class="row">
        ...
        <div class="col s12 m6 l4">
            ...
            <div class="card">
                ...
                <div class="card-image">
                    <img
                        src="../../resources/img/Trabajo_Pagina_Principal/Camisas/Camisas Marcas/Volcom/Volcom diamante gigante.jpg" height="662">
                </div>
                <!--Contenido de la Card-->
                <div class="card-content center">
                    <p>
                        <strong>Volcom diamante gigante</strong>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col s12 m6 l4">
            ...
            <div class="card">
                <!--Imagen de la Card-->
                <div class="card-image">
                    <img src="../../resources/img/Trabajo_Pagina_Principal/Camisas/Camisas Marcas/Volcom/Volcom Diamante.jpg"
                        height="662">
                </div>
                <!--Contenido de la Card-->
                <div class="card-content center">
                    <p>
                        <strong>Volcom Diamante</strong>
                    </p>
                </div>
            </div>
        </div>
        <div class="col s12 m6 l4">
            ...
            <div class="card">
                ...
                <div class="card-image">
                    <img
                        src="../../resources/img/Trabajo_Pagina_Principal/Camisas/Camisas Marcas/Volcom/Volcom Palmera.jpeg" height="662">
                </div>
                <!--Contenido de la Card-->
                <div class="card-content center">
                    <p>
                        <strong>Volcom Palmera</strong>
                    </p>
                </div>
            </div>
        </div>
