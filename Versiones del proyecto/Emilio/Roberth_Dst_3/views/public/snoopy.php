    ...
    <div class="row">
        ...
        <div class="col s12 m6 l4">
            ...
            <div class="card">
                ...
                <div class="card-image">
                    <img src="../../resources/img/Trabajo_Pagina_Principal/Blusas/Blusas Muñecos/N Snoopy/Snoopy Bomb.jpg" height="550">
                </div>
                <!--Contenido de la Card-->
                <div class="card-content center">
                    <p>
                        <strong>Snoopy Bomba</strong>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="col s12 m6 l4">
            ...
            <div class="card">
                <!--Imagen de la Card-->
                <div class="card-image">
                    <img src="../../resources/img/Trabajo_Pagina_Principal/Blusas/Blusas Muñecos/N Snoopy/Snoopy Corazon.jpg" height="550">
                </div>
                <!--Contenido de la Card-->
                <div class="card-content center">
                    <p>
                        <strong>Snoopy Corazon</strong>
                    </p>
                </div>
            </div>
        </div>       
        ...
        <div class="col s12 m6 l4">
            ...
            <div class="card">
                ...
                <div class="card-image">
                    <img
                        src="../../resources/img/Trabajo_Pagina_Principal/Blusas/Blusas Muñecos/N Snoopy/Snoopy LOVE.jpg" height="550">
                </div>
                <!--Contenido de la Card-->
                <div class="card-content center">
                    <p>
                        <strong>Snoopy LOVE</strong>
                    </p>
                </div>
            </div>
        </div>
