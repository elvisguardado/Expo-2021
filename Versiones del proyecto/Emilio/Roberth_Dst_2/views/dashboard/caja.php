                ...
                <div class="card">
                    <div class="card-content">
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <input type="text" placeholder="Ingrese Codigo de Caja" id="nombre">
                            <label for="Codigo de la Caja">Codigo de la Caja</label>
                        </div>
                        <!-- Estructura del formulario, cada div clas imput es una entrada de registro -->
                        <div class="input-field col s12 m6">
                            <input type="text" class="datepicker">
                            <label for="nombre">Fecha de la caja</label>
                        </div>
                        <!-- Estructura del formulario, cada div clas imput es una entrada de registro -->
                        <div class="input-field col s12 m6">
                            <i class="material-icons prefix">euro_symbol</i>
                            <input type="text" placeholder="Ingrese el precio de Caja" id="nombre">
                            <label for="nombre">Precio de la Caja</label>
                        </div>
                        ...
                        <table id="tabla1" class="highlight responsive-table centered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>2334</td>
                                    <td>07/02/2021</td>
                                    <td>$150.00</td> <!-- Los ultimos 2 botones abren un modal en el cual se podra actualizar o eliminar un registro dependiendo lo que elija -->
                                ...
                                <tr>
                                    ...
                                    <td>2346</td>
                                    <td>21/02/2021</td>
                                    <td>$200.00</td> <!-- Los ultimos 2 botones abren un modal en el cual se podra actualizar o eliminar un regitro dependiendo lo que elija -->
                                    <td><a class="btn-floating btn-small waves-effect waves-light light-blue accent-2 btn modal-trigger" href="#modal1"><i class="material-icons">autorenew</i>Modal</a></td>
                                    <td><a class="btn-floating btn-small waves-effect waves-light red btn modal-trigger" href="#modal2"><i class="material-icons">delete</i>Modal</a></td>
                                </tr>
                                <tr>
                                    ...
                                    <td>7823</td>
                                    <td>07/03/2021</td>
                                    <td>$95.00</td> <!-- Los ultimos 2 botones abren un modal en el cual se podra actualizar o eliminar un registro dependiendo lo que elija  -->
                                    <td><a class="btn-floating btn-small waves-effect waves-light light-blue accent-2 btn modal-trigger" href="#modal1"><i class="material-icons">autorenew</i>Modal</a></td>
                                    <td><a class="btn-floating btn-small waves-effect waves-light red btn modal-trigger" href="#modal2"><i class="material-icons">delete</i>Modal</a></td>
                                </tr>
                            </tbody>
