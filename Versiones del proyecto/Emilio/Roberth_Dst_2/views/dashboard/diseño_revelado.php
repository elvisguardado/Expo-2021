        ...
        <form class="col12">
            <div class="row card-panel">
                <div class="card">
                    <div class="card-content">
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <input type="text" placeholder="Ingrese su Estado" id="nombre">
                        ...
                        <div class="input-field col s12 m6">
                            ...
                            <input type="text" placeholder="Cantidad de Marcos" id="nombre">
                            <label for="nombre">Marcos</label>
                        </div>
                    ...
                    <div class="center-align">
                        <h5>Visualizar los Diseños Revelados</h5>
                    </div>
                    ...
                    <div class="card-content grey lighten-4">
                        ...
                        <table id="tabla1" class="highlight responsive-table centered">
                            <thead>
                                <tr>
                                    <th>Diseño</th> <!-- Parte superior de la tabla indicando que tipo de datos se ingresaran -->
                                    <th>Empleado</th>
                                    <th>Estado</th>
                                    <th>Fecha</th>
                                    <th>Foto</th>
                                    <th>Cantidad_Marcos</th>
                                    <th>Actualizar</th>
                                    <th>Eliminar</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td>Girasoles</td> <!-- Datos Ingresados -->
                                    <td>Emilio Guerra</td>
                                    <td>En proceso</td>
                                    <td>26/01/2021</td>
                                ...
                                <tr>
                                    <td>Pandas</td> <!-- Datos Ingresados -->
                                    <td>Marcos Umanzor</td>
                                    <td>En proceso</td>
                                    <td>15/02/2021</td>
                                ...
                                <tr>
                                    <td>Mariposas</td> <!-- Datos Ingresados -->
                                    <td>Elvis Guardado</td>
                                    <td>En proceso</td>
                                    <td>02/03/2021</td>
                ...
                <div id="modal2" class="modal">
                    <div class="modal-content">
                        <div class="center-align">
                            <br> <!-- Mensaje que se muestra sobre la accion que va realizar. para alertarlo que son cambios permanentes -->
...
plantilla_index::footerTemplate('diseño_revelado.js');
?>